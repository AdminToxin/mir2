...
namespace Client.MirObjects
{
    public class PlayerObject : MapObject
    {
        ...
        public MLibrary WeaponLibrary1, WeaponEffectLibrary1, WeaponLibrary2, HairLibrary, WingLibrary, MountLibrary; //weaponeffect
        public int Armour, Weapon, WeaponEffect, ArmourOffSet, HairOffSet, WeaponOffSet, WingOffset, MountOffset; //weaponeffect
        ...
        public void Load(S.ObjectPlayer info)
        {
            ...
            Weapon = info.Weapon;
            WeaponEffect = info.WeaponEffect; //weaponeffect
            Armour = info.Armour;
            Light = info.Light;
        ...
        public virtual void SetEffects()
        {
            ...
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 1403, 10, 3200, this, true, true, 1) { Repeat = true });
                SpecialEffect effect = new SpecialEffect(Libraries.Effect, 680, 20, 4200, this, true, false, 1) { Repeat = true, Delay = delay };
            ...
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 296, 28, 3600, this, true, false, 1) { Repeat = true });
            }
          //if (LevelEffects.HasFlag(LevelEffects.RedAura))
          //{
          //    Effects.Add(new SpecialEffect(Libraries.Effect, 1251, 20, 3600, this, true, true, 1) { Repeat = true });
          //}
            if (LevelEffects.HasFlag(LevelEffects.Mir3White))
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 1348, 16, 2200, this, true, false, 1) { Repeat = true });
            }
            if (LevelEffects.HasFlag(LevelEffects.YellowAura))
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 1364, 13, 2200, this, true, false, 1) { Repeat = true });
            }
            if (LevelEffects.HasFlag(LevelEffects.BlueAura))
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 1377, 16, 2200, this, true, false, 1) { Repeat = true });
            }
            if (LevelEffects.HasFlag(LevelEffects.PurpleAura))
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 1413, 10, 3200, this, true, true, 1) { Repeat = true });
            }
            if (LevelEffects.HasFlag(LevelEffects.Shields))
            {
                Effects.Add(new SpecialEffect(Libraries.Effect, 1331, 12, 2200, this, true, false, 1) { Repeat = true });
            }
        }
                    ...
                    case MirAction.Spell:
                        ...
                        switch (Spell)
                        {
                            ...
                            case Spell.LightningStorm:
                                Effects.Add(new Effect(Libraries.Magic4, 1630, 8, Frame.Count * FrameInterval, this));
                                SoundManager.PlaySound(20000 + 100 * 10);
                                break;
                            ...
                            case Spell.MagicShield:
                                Effects.Add(new Effect(Libraries.Magic, 4041, 17, Frame.Count * FrameInterval, this));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                break;
                            ...
                            case Spell.MeteorStrike:
                                Effects.Add(new Effect(Libraries.Mir3Magic, 430, 10, Frame.Count * FrameInterval, this));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                BlizzardStopTime = CMain.Time + 3000;
                                break;
                            ...
                            #region UnlimitedBladeWorks
                            case Spell.UnlimitedBladeWorks:
                                MapControl.Effects.Add(new Effect(Libraries.Magic4, 2920, 12, 1200, CurrentLocation));
                                SoundManager.PlaySound(20000 + 139 * 10);
                                break;
                            #endregion
            ...
            if (MagicShield)
            {
                switch (CurrentAction)
                {
                    ...
                    case MirAction.MountStruck:
                        ...
                        Effects.Add(ShieldEffect = new Effect(Libraries.Magic, 4061, 3, 600, this));
                        ShieldEffect.Complete += (o, e) => Effects.Add(ShieldEffect = new Effect(Libraries.Magic, 4058, 3, 600, this) { Repeat = true });
                        break;
                    default:
                        if (ShieldEffect == null)
                            Effects.Add(ShieldEffect = new Effect(Libraries.Magic, 4061, 3, 600, this) { Repeat = true });
                        break;
                }
            }
                            ...
                            if (Cast)
                            {
                                ...
                                switch (Spell)
                                {
                                    ...
                                    case Spell.LightningStorm:
                                        ...
                                        SoundManager.PlaySound(20000 + 42 * 10);
                                        MapControl.Effects.Add(new Effect(Libraries.Magic4, 1640, 11, 1000, TargetPoint));
                                        break;
                                    ...
                                    case Spell.SoulShield:
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                        missile = CreateProjectile(1160, Libraries.Magic, true, 3, 30, 7, 6, Color.FromArgb(254, 42, 48, 77));
                                        missile.Explode = true;

                                        missile.Complete += (o, e) =>
                                        {
                                            MapControl.Effects.Add(new Effect(Libraries.Mir3Magic, 86, 8, 1200, TargetPoint, 0, false, 6, Color.FromArgb(0, 42, 48, 77))); //{ Light = 2, LightColour = Color.Blue });
                                            //MapControl.Effects.Add(new LightEffect(600, TargetPoint, 0, 6, Color.FromArgb(255, 144, 195, 212)));
                                    ...
                                    case Spell.BlessedArmour:
                                        ...
                                        missile.Complete += (o, e) =>
                                        {
                                            MapControl.Effects.Add(new Effect(Libraries.Mir3Magic, 78, 8, 1200, TargetPoint));
        ...
        public void DrawCurrentEffects()
        {
            ...
            {
                MagicShield = true;
                Effects.Add(ShieldEffect = new Effect(Libraries.Magic, 4058, 3, 600, this) { Repeat = true });
        ...
        public void DrawWeapon()
        {
            ...
            if (WeaponLibrary1 != null)
            {
                ...
                {
                    WeaponEffectLibrary1.DrawBlend(DrawFrame + WeaponOffSet, DrawLocation, DrawColour, true, 5.8F);
                }
            }
        }
